...
export const SITE_DESCRIPTION =
  ...
  'итальянское оборудование, опыт сотрудников 15+ лет. Одежда, шубы и кожа, текстиль.'
 ...
 *
 * Здесь только то, что подтверждено в PRODUCT.md. Сознательно отсутствуют:
 * openingHours и номер дома (не подтверждены), geo (без дома нет координат),
 * priceRange (прайса нет), aggregateRating и review — отзывы на сайте пока
 * демонстрационные, а разметка выдуманных оценок это уже поисковый спам.
 */
export const schema = {
